...
export default function Actions({ post }) {
  ...
  const handleLikeUnlike = async () => {
    if (!user) return showToast("Error", "Login to like it");
    if (liking) return;
    try {
      setLiking(true);
  ...
  const handleReply = async () => {
    if (!user) return showToast("Error", "Login to reply on a post");
    if (replying) return;
    try {
      setReplying(true);
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            ...
            <Button size={"sm"} onClick={onClose} isDisabled={replying}>
              Cancel
            </Button>
          </ModalFooter>
        </ModalContent>
